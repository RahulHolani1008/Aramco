  ...
  <div>
    ...
    <nav aria-label="Departments Pagination">
      <div class="position-relative">
        <div class="card height-max width-90 rounded-100px centered mb-3">
          <div class="card-body d-grid px-3 grid-de-la-tnc">
            <div class="rounded-100 lightGray--bg width-90 height-80 text-center vertical-centered centered" style="padding-top: inherit">3</div>
      ...
      <div class="position-relative">
        <div class="card height-max width-90 rounded-100px centered mb-3">
          <div class="card-body d-grid px-3 grid-de-la-tnc">
            <div class="rounded-100 lightGray--bg width-90 height-80 text-center vertical-centered centered" style="padding-top: inherit">1</div>
            <div class="vertical-centered pl-4 gray">Queue</div>
            <div class="vertical-centered pl-4">2020-02-25 10:46:46</div>
            <button type="button" class="btn btn-no-border btn-sm">
            <div
      ...
      <div class="position-relative">
        <div class="card height-max width-90 rounded-100px centered mb-3">
          <div class="card-body d-grid px-3 grid-de-la-tnc">
            <div class="rounded-100 lightGray--bg width-90 height-80 text-center vertical-centered centered" style="padding-top: inherit">5</div>
            <div class="vertical-centered pl-4 gray">Queue</div>
            <div class="vertical-centered pl-4">2020-02-25 10:46:46</div>
            <button type="button" class="btn btn-no-border btn-sm">
            <div
      ...
      <div class="position-relative">
        <div class="card height-max width-90 rounded-100px centered mb-3">
          <div class="card-body d-grid px-3 grid-de-la-tnc">
            <div class="rounded-100 lightGray--bg width-90 height-80 text-center vertical-centered centered" style="padding-top: inherit">4</div>
            <div class="vertical-centered pl-4 gray">Queue</div>
            <div class="vertical-centered pl-4">2020-02-25 10:46:46</div>
            <button type="button" class="btn btn-no-border btn-sm">
            <div
...
@Component
export default class MergingServices extends Vue {}
</script>
