<template>
  <div>
    <button
      class="btn primary--bg btn-no-border btn-lg px-5 white rounded-50 ml-50 mb-2"
      data-toggle="modal"
    ...
    <div class="d-flex justify-space-around">
      ...
      <div class="card card-left">
        <div class="card-body">
          ...
          <img src="../../assets/atom.png" class="centered mt--50 width-50" />
          <div class="bold text-center fs--16 width-100 mt--30">
            Title of Programs
          </div>
          <div class="width-90 py-2 mt-2 centered rounded-50 lightBlue--bg">
    ...
    <div class="d-flex mt-40 justify-space-around">
      <div class="card card-left">
        <div class="card-body">
          <button type="button" class="btn btn-no-border btn-sm">
            <div
        ...
        <div class="modal-content">
          <div class="modal-body d-flex justify-space-around">
            <input
              ...
              placeholder="The name of Program"
            />
          </div>
